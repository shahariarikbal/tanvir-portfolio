                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header bg-primary">
                                <h3 class="text-white">Slider list</h3>
                                <a href="{{ url('/slider/add') }}" class="btn btn-success float-right" style="margin-top: -36px;">Add Slider</a>
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('slider/'.$value->image) }}" height="50" width="100">
                                        </td>
                                        <td>
                                            <a href="{{ url('slider/edit/'.$value->id) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
                                            <form action="{{ url('slider/destroy/'. $value->id) }}" method="POST">
                                                @csrf
                        ...
                        <div class="card">
                            <div class="card-header bg-success">
                                <h3 class="text-white">Slider create</h3>
                                <a href="{{ url('/slider/list') }}" class="btn btn-danger float-right" style="margin-top: -36px;"><i class="fa fa-arrow-alt-circle-left"></i> Back</a>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header bg-success">
                                <h3 class="text-white">Slider update</h3>
                                <a href="{{ url('/slider/list') }}" class="btn btn-danger float-right" style="margin-top: -36px;"><i class="fa fa-arrow-alt-circle-left"></i> Back</a>
                            </div>
                            <form action="{{ url('slider/update/'. $slider->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="title">Title <small style="color: red">*</small></label>
                                        <input type="text" name="title" class="form-control" value="{{ $slider->title }}" id="title" placeholder="Title here">
                                        <span style="color: red"> {{ $errors->has('title') ? $errors->first('title') : ' ' }}</span>
                                    </div>
                                    <div class="form-group">
                                        <label for="image">Image <small style="color: red">*</small></label>
