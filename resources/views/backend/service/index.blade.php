                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header bg-primary">
                                ...
                                <a href="{{ route('services.create') }}" class="btn btn-success float-right" style="margin-top: -36px;">Add service</a>
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $value->title }}</td>
                                        <td>
                                            <img src="{{ asset('service/'.$value->image) }}" height="50" width="100">
                                        </td>
                                        <td>{{ Str::substr($value->description, 0, 20) }}</td>
                                        <td>
                                            <a href="{{ route('services.edit', $value->id) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
                        ...
                        <div class="card">
                            <div class="card-header bg-success">
                                <h3 class="text-white">Service create</h3>
                                <a href="{{ route('services.index') }}" class="btn btn-danger float-right" style="margin-top: -36px;"><i class="fa fa-arrow-alt-circle-left"></i> Back</a>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header bg-success">
                                <h3 class="text-white">Service update</h3>
                                <a href="{{ route('services.index') }}" class="btn btn-danger float-right" style="margin-top: -36px;"><i class="fa fa-arrow-alt-circle-left"></i> Back</a>
                            </div>
                            <form action="{{ route('services.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="title">Title <small style="color: red">*</small></label>
                                        <input type="text" name="title" class="form-control" value="{{ $data->title }}" id="title" placeholder="Title here">
                                        <span style="color: red"> {{ $errors->has('title') ? $errors->first('title') : ' ' }}</span>
                                    </div>
                                    <div class="form-group">
                                        <label for="short_description">Description <small style="color: red">*</small></label>
                                        <textarea name="description" rows="5" class="form-control"
                                                  id="description" placeholder="Designation here">{{ $data->description }}</textarea>
                                        <span style="color: red"> {{ $errors->has('short_description') ? $errors->first('short_description') : ' ' }}</span>
                                    </div>
                                    <div class="form-group">
                                        <label for="image">Image <small style="color: red">*</small></label>
                                        <input type="file" name="image" class="form-control" id="image">
                                        <img src="{{ asset('service/'.$data->image) }}" height="80" width="80">
                                        <span style="color: red"> {{ $errors->has('image') ? $errors->first('image') : ' ' }}</span>
                                    </div>
